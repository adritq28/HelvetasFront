...
import 'package:helvetasfront/screens/MyTextField2.dart';
                  ...
                  InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        padding: EdgeInsets.symmetric(vertical: 10, horizontal: 20),
                        decoration: BoxDecoration(
                          color: const Color.fromARGB(255, 125, 130, 125),
                        ...
                        child: const Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 8.0),
                            Text('Grafica', style: TextStyle(fontSize: 18.0, color: Colors.white)),
                          ],
                        ),
                      ),
                    ),
                  ...
                  InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        padding: EdgeInsets.symmetric(vertical: 10, horizontal: 20),
                        decoration: BoxDecoration(
                          color: const Color.fromARGB(255, 49, 194, 125),
                          borderRadius: BorderRadius.circular(10),
                        ),
                        child: const Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            ...
                            SizedBox(width: 8.0),
                            Text('Guardar', style: TextStyle(fontSize: 18.0, color: Colors.white)),
                          ],
                        ),
                      ),
                    ),
